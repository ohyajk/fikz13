            ...
            <div className='w-full py-5 max-w-4xl mx-auto'>
                <div className='col-span-3 flex flex-col gap-5 md:px-28'>
                    <div className='flex flex-col gap-4'>
                        ...
                        <input className='py-3 px-6 rounded-xl w-full bg-[#F5F5F5]' type='text' placeholder='Email' />
                    </div>
                    <div className='flex flex-col gap-4'>
                        <label className='text-lg'>
                            <span>Work Phone</span>
                        </label>
                        <input className='py-3 px-6 rounded-xl w-full bg-[#F5F5F5] appearance-none' type='number' placeholder='Work Phone' />
                    </div>
                    <div className='flex flex-col gap-4'>
                        <label className='text-lg'>
                            <span>Business Name</span>
                        </label>
                        <input className='py-3 px-6 rounded-xl w-full bg-[#F5F5F5]' type='text' placeholder='Business Name' />
                    </div>
                    <div className='flex flex-col gap-4'>
                        <label className='text-lg'>
                            <span>EIN</span>
                        </label>
                        <input className='py-3 px-6 rounded-xl w-full bg-[#F5F5F5]' type='text' placeholder='EIN' />
                    </div>
                </div>
            </div>
        </section>
